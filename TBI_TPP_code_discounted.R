...
SA_costs <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "Template_SA", col_types = "numeric", range = "A1:T16001")
Brazil_costs <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "Template_Brazil", col_types = "numeric", range = "A1:T16001")

#Load South African mathematical model epidemiological outputs
SA_baseline <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "SA_baseline_data", col_types = "numeric", range = "A1:R16001")
SA_scaleup <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "SA_scaleup_data", col_types = "numeric", range = "A1:R16001")
SA_minimal <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "SA_minimal_data", col_types = "numeric", range = "A1:R16001")
SA_optimal <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "SA_optimal_data", col_types = "numeric", range = "A1:R16001")
...
#Load the micro costing summaries
  ...
  Brazil_baseline <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "Brazil_baseline_data", col_types = "numeric", range = "A1:R16001")
  Brazil_scaleup <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "Brazil_scaleup_data", col_types = "numeric", range = "A1:R16001")
  Brazil_minimal <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "Brazil_minimal_data", col_types = "numeric", range = "A1:R16001")
  Brazil_optimal <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "Brazil_optimal_data", col_types = "numeric", range = "A1:R16001")
...
Brazil_overall_cost_table<-Brazil_cost_MDRTB_cumulat %>% 
  group_by(cost_pop, strategy,population) %>% 
  summarise_at(vars(x),
               list(median=median,
                    mean=mean,
                    quantile_lower = ~quantile(., probs = 0.025),
                    quantile_upper = ~quantile(., probs = 0.975)))
write.csv(Brazil_overall_cost_table, file = "1C. Brazil cumulative cost RR-TB dig&tx output tables.csv")
...
SA_DR96 <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "SA_DR96_data", col_types = "numeric", range = "A1:R16001")
SA_DR97 <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "SA_DR97_data", col_types = "numeric", range = "A1:R16001")
SA_DR98 <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "SA_DR98_data", col_types = "numeric", range = "A1:R16001")
SA_DR99 <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "SA_DR99_data", col_types = "numeric", range = "A1:R16001")
SA_DR25 <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "SA_DR25_data", col_types = "numeric", range = "A1:R16001")
SA_DR75 <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "SA_DR75_data", col_types = "numeric", range = "A1:R16001")
...
#####################################################################################################################
#Load South African mathematical model epidemiological outputs - DR barriers
Brazil_DR96 <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "Brazil_DR96_data", col_types = "numeric", range = "A1:R16001")
Brazil_DR97 <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "Brazil_DR97_data", col_types = "numeric", range = "A1:R16001")
Brazil_DR98 <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "Brazil_DR98_data", col_types = "numeric", range = "A1:R16001")
Brazil_DR99 <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "Brazil_DR99_data", col_types = "numeric", range = "A1:R16001")
Brazil_DR25 <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "Brazil_DR25_data", col_types = "numeric", range = "A1:R16001")
Brazil_DR75 <- readxl::read_xlsx("Raw_Datasets_LTBI_TPP_discounted.xlsx", sheet = "Brazil_DR75_data", col_types = "numeric", range = "A1:R16001")
...
write.csv(Brazil_epi_cumulative_DALYs, file = "Brazil DALYs.csv")
write.csv(Brazil_epi_cumulative_TBall, file = "Brazil TB cases.csv")
write.csv(Brazil_epi_cumulative_TBdeaths, file = "Brazil TB deaths.csv")

write.csv(SA_epi_cumulative_DALYs, file = "SA DALYs.csv")
write.csv(SA_epi_cumulative_TBall, file = "SA TB cases.csv")
write.csv(SA_epi_cumulative_TBdeaths, file = "SA TB deaths.csv")
